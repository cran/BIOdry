...
### This function fits LME models of multilevel data frames.
                        ##details<<This function implements
                        ##\code{\link{lme}} to fit linear
                        ##mixed-effects models on multilevel
                        ##dendrochronological data sets processed by
                        ##function \code{\link{modelFrame}}. Two kind
                        ...
                        ##any of these methods. After lme models are
                        ##fitted, they can be extended by implementing
                        ##methods in package \code{\link{nlme}}.
                        ##references<< Pinheiro J. C.,
                        ##D. M. Bates. 2000. Mixed-effects models in S
                        ##and S-PLUS. Springer, New York.
(
    rd, ##<<\code{data.frame}.Multilevel dendrochronological data set
        ##containing classification factors.
    form = 'lmeForm', ##<<\code{character}. Name of a method of lme
                      ##formula. Available methods are 'lmeForm' and
                      ##'tdForm' (see details).
    res.data =TRUE, ##<< \code{logical}. Save residuals as a
    ##multilevel dendrochronological data frame. If TRUE then a data
    ##frame of name 'resid' is added to output list.
    ... ##<< Further arguments to be passed to \code{\link{lme}} or
    ##the lme function in \code{form}.
) {
...
### containing initial factor-level columns.
    ...
    ## Detrending tree growth with a (l)td-form model:
